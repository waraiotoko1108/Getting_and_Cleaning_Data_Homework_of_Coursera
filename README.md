...
* The file run_analysis.R performs the following steps th clean the data for the project:  
 ...
 11.Finally, generate a second independent tidy data set with the average of each measurement for each activity and each subject.we have 30 unique subjects and 6 unique activities, which result in a 180 combinations of the the tw. Then,for each combination, we calculate the mean of each measurement with the corresponding combination. So, after initializing the *result* data frame and performing the two for-loops, we get a 180¡Á68 data frame.  
